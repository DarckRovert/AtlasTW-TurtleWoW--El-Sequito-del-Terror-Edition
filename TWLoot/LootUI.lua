...
local function AtlasTWLoot_CreatePresetButtons(frame)
    ...
    for i = 1, 6 do
        ...
        presetButton[i]:SetWidth(115)
        presetButton[i]:SetText(L["QuickLook"] .. " " .. i)
        if i == 1 then
            presetButton[i]:SetPoint("LEFT", frame, "LEFT", 15, 10)
        else
            presetButton[i]:SetPoint("LEFT", presetButton[i - 1], "RIGHT", 12, 0)
        end
...
local function AtlasTWLoot_CreateSearchElements(frame)
    ...
    searchBox:SetPoint("BOTTOMLEFT", frame, "BOTTOMLEFT", 130, 12)
...
local function AtlasTWLoot_CreatePanel()
    ...
    world:SetWidth(70)
    world:SetPoint("LEFT", frame, "LEFT", 15, 45)
    ...
    worldEvents:SetWidth(115)
    worldEvents:SetPoint("LEFT", world, "RIGHT", 6, 0)
    ...
    sets:SetWidth(100)
    sets:SetPoint("LEFT", worldEvents, "RIGHT", 10, 0)
    ...
    reputation:SetWidth(95)
    reputation:SetPoint("LEFT", sets, "RIGHT", 10, 0)
    ...
    pvp:SetWidth(110)
    pvp:SetPoint("LEFT", reputation, "RIGHT", 10, 0)
    ...
    crafting:SetWidth(105)
    crafting:SetPoint("LEFT", pvp, "RIGHT", 10, 0)
    ...
    dungeons:SetWidth(135)
    dungeons:SetPoint("LEFT", crafting, "RIGHT", 10, 0)
