# Atlas‑TW — El Séquito del Terror Edition (WoW 1.12)

Overview: Atlas‑TW is a dungeon map browser with an integrated loot panel and quests module. This special "El Séquito del Terror" clan edition features a modernized UI, guild branding, and enhanced technical fixes for Turtle WoW.
...
- Open/Close Atlas‑TW: /atlastw
- Open options: /atlastw options (or /atlastw opt)
...
4) Key Features (El Séquito Edition)
- **Modernized Layout (v9.3.1 [God-Tier])**:
  - Unified Loot Panel expanded to 800x125 for superior item browsing.
  - Clan "El Séquito" Branding integrated into the main header.
  - Header buttons repositioned to ensure zero overlap with localization.
- **Legacy Data Migration**:
  - Automatically absorbs Wishlists and QuickLooks from legacy AtlasLoot installations.
  - Conflict-free design: resolves the "Double Atlas" issue on Turtle WoW.
...
- **Self-Migration**: The addon will automatically import search history and wishlists from AtlasLoot on first load.
...
s: which maps/quests/rewards are incorrect, your client language, and client version